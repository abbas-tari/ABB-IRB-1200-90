...
static struct PyModuleDef pyikfast_abb_irb_1200_90module = {
    PyModuleDef_HEAD_INIT,
    "pyikfast_abb_irb_1200_90",
    "ikfast wrapper",
    -1,
    PyIkFastMethods};

PyMODINIT_FUNC PyInit_pyikfast_abb_irb_1200_90(void)
{
  PyObject *module = PyModule_Create(&pyikfast_abb_irb_1200_90module);
  return module;
}
